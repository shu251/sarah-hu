...
![On board the RV Thomas G Thompson for PROTATAX23. July 2023](images/TN420-Sarah-6.jpg){fig-align="left" width="280"}

::: {style="float:left"}
```{r, echo=FALSE, out.width= "250px", out.extra='style="float:left; padding:20px"'}
...
I'm most excited about research in the deep-sea, especially biologically rich habitats like hydrothermal vents. I love teaching and mentoring about all things biological oceanography, coding, and more! This lab is built on a shared love for the natural world.
...
::: {style="float:left"}
```{r, echo=FALSE, out.width= "250px", out.extra='style="float:left; padding:30px"'}
knitr::include_graphics("images/woodward.jpg")
```
:::
...
Abby is an Environmental Geoscience major minoring in Anthropology and GIST. She is extremely interested in the world around us, both the past and what is currently going on today. As an Environmental Geoscience major minoring in Anthropology, she hopes to pursue a career that can combine both of these fields. In the past, Abby did research on microorganisms and what their distribution in the water column could tell us about past climates. That study has continued to pique her interest and she is pursing similar work in the Hu lab.
...
Madeleine is a Zoology major and ECCB minor from Corpus Christi, Texas. After graduating from Texas A&M University, she hopes to attend graduate school to become a marine biologist and pursue a career in research. She is undecided about the specialty she may choose, but is passionate about marine ecosystems. In her free time, she enjoys reading, listening to music, and exploring nature.
...
Meagan Sonsel is an Environmental Geoscience major with a concentration in biosphere. She is extremely excited to work in the lab and discover more about microbial eukaryotes in the deep sea.
...
Siddharth is a freshman at Texas A&M University, class of 2027, majoring in Oceanography. Playing football (not American football) has been a passion of his and he hopes to play for the A&M team soon. Siddarth has a deep curiosity for the mysteries of the ocean, and his goal is to contribute to the progress of this field. Eager to explore the wonders of marine science and dedicated to making a positive impact, he looks forward to the exciting journey that lies ahead.
...
Please contact me (skh\[at\]tamu.edu) if you are interested in working together. **I do not currently have any open positions for Masters, PhD, or Postdoctoral positions**. Watch this space for future opportunities.
